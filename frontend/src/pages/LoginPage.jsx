...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen md:grid md:grid-cols-2 bg-white text-grey-800">
      {/* Left Side: Login Form */}
      <div className="flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          <h1 className="text-3xl font-bold">Login</h1>
          <p className="mt-2 text-gray-800">Welcome back to ChitChat.</p>
          ...
          <p className="mt-8 text-sm text-center text-gray-800">
            Don't have an account?{' '}
            <Link to="/register" className="font-medium text-blue-800 hover:text-blue-800">Sign Up</Link>
          </p>
        </div>
      </div>
      ...
      <div className="hidden md:flex flex-col items-center justify-center p-12 relative">
        <div className="text-center">
            <h2 className="text-5xl font-extrabold text-white">Welcome to <span className="text-blue-800">ChitChat</span></h2>
            <div className="mt-4 h-16 text-3xl font-semibold text-gray-800">
              <span>{displayedText}</span>
              <span className="animate-ping">|</span>
            </div>
        </div>
        <div className="absolute bottom-8 text-center text-gray-800">
            <p>Developed with ❤️ in India</p>
            <p>by{' '}
              <a href="#" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-400">Aditi</a>
            </p>
        </div>
      </div>
    </div>
